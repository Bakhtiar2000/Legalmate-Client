        ...
        <div>
            <div className="flex flex-col gap-2" ref={scroll}>
                <div className={sms.senderId === currentUser._id ? ' flex flex-col self-end my-2' : 'flex flex-col my-2 self-start'}>
                    <p className={sms.senderId === currentUser._id ? 'text-white bg-green px-3 py-1 rounded-full rounded-br-none shadow-lg shadow-green/40 min-w-[150px] text-center' : 'text-white bg-black px-3 py-1 rounded-full rounded-tl-none shadow-lg shadow-black/40 min-w-[150px] text-center'}>
