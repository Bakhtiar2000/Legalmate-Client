...

            {
                ...
                >
                    ...
                    <div className="overflow-y-hidden">
                        ...
                        {/* Modal content */}
                        <p className="my-6">We're excited to welcome you as a valued member of our platform, where you can connect with clients from all over the country who are seeking your expertise. As an attorney on our platform, you have the unique opportunity to engage with clients, offering your guidance and support to those in need. You'll have access to legal posts in various practice areas, providing you with a diverse range of opportunities to showcase your skills. Thank you for choosing to be a part of our esteemed network of legal professionals.</p>
